        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-3">
                <ul class="secondary-links">
                    ...
                    <li><a href="{{ route('kunjungi') }}" class="active">KUNJUNGI</a></li>
                </ul>
            </div>
        </div>
    </div>
...
<section class="hero-section">
    <div class="hero-image">
        <img src="https://images.unsplash.com/photo-1523050854058-8df90110c9f1?ixlib=rb-4.0.3&auto=format&fit=crop&w=2070&q=80" alt="Visit Hero">
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-8 text-center">
                    <h1 class="hero-title">Kunjungi Bellford Academy</h1>
                    <p class="hero-subtitle">Lihat langsung fasilitas dan lingkungan belajar yang kondusif</p>
                </div>
            </div>
        </div>
    </div>
...
<!-- Visit Content (Updated: Map left, Contact right) -->
<section class="visit-content-section">
    <div class="container">
        <div class="row">
            <div class="col-lg-8">
