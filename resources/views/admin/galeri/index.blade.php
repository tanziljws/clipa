...
<div class="container">
    ...
    <div class="category-bar mb-4">
        <a class="cat-pill {{ !request('kategori') || request('kategori')==='all' ? 'active' : '' }}" href="{{ route('galeri.index') }}">
        ...
        @isset($kategori)
            @foreach($kategori as $k)
                ...
                <a class="cat-pill {{ request('kategori') == $k->id_kategori ? 'active' : '' }}" href="{{ route('galeri.index', ['kategori' => $k->id_kategori]) }}">
    ...
    <table class="table table-modern w-100">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="{{ route('galeri.edit',$item->id_galeri) }}" class="btn btn-soft-warning btn-sm">Edit</a>
                    <a href="{{ route('galeri.destroy',$item->id_galeri) }}" class="btn btn-soft-danger btn-sm" onclick="return confirm('Yakin hapus?')">Hapus</a>
                </td>
            </tr>
            @endforeach
        </tbody>
